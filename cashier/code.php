...
else if(isset($_POST['add_billing_btn']))
{
    ...
    $insert_billing_query = "INSERT INTO billing (client_id, billing_num, covered_from, covered_to, reading_date, due_date,
                            previous_reading, present_reading, consumption, billing_amount, arrears, surcharge, materials_fee,
    ...
    mysqli_stmt_bind_param($stmt, "isssssiiiddddddddddsdds", $client_id, $billing_num, $covered_from, $covered_to, $reading_date,
                            $due_date, $previous_reading, $present_reading, $consumption, $billing_amount, $arrears, $surcharge,
...
else if(isset($_POST['add_otherpayment_btn']))
{
    ...
    // Escaping and validating inputs
    $client_id = mysqli_real_escape_string($conn, $_POST['client_id']);
    $or_num = mysqli_real_escape_string($conn, $_POST['or_num']);
    $payment_date = mysqli_real_escape_string($conn, $_POST['payment_date']);
    $payment_purpose = mysqli_real_escape_string($conn, $_POST['payment_purpose']);
    ...
    // Bind the parameters (Note: Correct the data types as necessary)
