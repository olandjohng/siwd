                ...
                <table class="table table-flush dataTable-table data-table" id="billingTable">
                    ...
                    <tbody>
                        <?php
                            if($billing && count($billing) > 0) {
                                ...
                                foreach($billing as $row) {
                                    ...
                                    if ($due_date < date('M d Y') && $row['status'] !== 'Paid' && $row['status'] !== 'Rolled Over') {
                                        $status = 'Due';
                                        $id = $row['billing_id'];
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="view-billing.php?id=<?= $id; ?>">
                                            <svg class="dropdown-icon text-success me-2 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php
                                ...
                                echo '<tr><td colspan="4">No billing data found.</td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
