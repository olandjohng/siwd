...
!function(e, t) {
    ...
    var O = function() {
      ...
      , S = Math.min;
    function k(e, t, i) {
        var s, r, l, o, n, a, c = 0, h = !1, d = !1, u = !0;
        ...
        function y() {
            ...
            return void 0 === n && (n = setTimeout(g, t)),
            o
        }
        return t = E(t) || 0,
        v(i) && (h = !!i.leading,
    ...
    function A(e, t, i) {
        ...
        if ("function" != typeof e)
            throw new TypeError("Expected a function");
        return v(i) && (s = "leading"in i ? !!i.leading : s,
    ...
    function T(e) {
        for (var i = 1; i < arguments.length; i++) {
            ...
            i % 2 ? z(Object(s), !0).forEach((function(i) {
                t(e, i, s[i])
            }
    ...
    var D = function() {
        function t(e) {
            ...
            this.onMouseEnter = function() {
                s.isMouseEntering || (s.el.classList.add(s.classNames.mouseEntered),
                s.isMouseEntering = !0),
                s.onMouseEntered()
            }
            ,
            ...
            this.onWindowResize = function() {
                s.scrollbarWidth = t.getScrollbarWidth(),
            ...
            this.drag = function(e) {
                ...
                e.preventDefault(),
                e.stopPropagation();
                var a = (("y" === s.draggedAxis ? e.pageY : e.pageX) - i.rect[s.axis[s.draggedAxis].offsetAttr] - s.axis[s.draggedAxis].dragOffset) / (r - l.size) * (o - n);
                "x" === s.draggedAxis && (a = s.isRtl && t.getRtlHelpers().isScrollOriginAtZero ? a - (r + l.size) : a),
            ...
            t.instances.has(this.el) || (r.classNames && console.warn("simplebar: classNames option is deprecated. Please override the styles with CSS instead."),
            ...
            this.onWindowResize = k(this.onWindowResize, 64, {
                leading: !0
            }),
            this.onStopScrolling = k(this.onStopScrolling, this.stopScrollDelay),
        ...
        (l = [{
            ...
            value: function() {
                ...
                return t = Math.max(~~(r * s), this.options.scrollbarMinSize),
            ...
            value: function() {
                ...
                if (this.axis[e].isOverflowing) {
                    var i = this.contentWrapperEl[this.axis[e].scrollSizeAttr]
                      ...
                      , n = (o = "x" === e && this.isRtl && t.getRtlHelpers().isScrollOriginAtZero ? -o : o) / (i - r)
                      , a = ~~((s - l.size) * n);
                    a = "x" === e && this.isRtl && t.getRtlHelpers().isScrollingToNegative ? -a + (s - l.size) : a,
                    l.el.style.transform = "x" === e ? "translate3d(".concat(a, "px, 0, 0)") : "translate3d(0, ".concat(a, "px, 0)")
                }
            }
        }, {
            ...
            value: function() {
                ...
                this.isWithinBounds(this.axis[e].track.rect) ? this.axis[e].track.el.classList.add(this.classNames.hover) : this.axis[e].track.el.classList.remove(this.classNames.hover)
            }
        }, {
                ...
                if (this.options.clickOnTrack) {
                    ...
                    var r = this.axis[i].scrollbar
                      ...
                      , u = function e() {
                        ...
                        s.requestAnimationFrame(e)) : n < h && (n += d,
                        t.contentWrapperEl[t.axis[i].scrollOffsetAttr] = n,
    ...
    return D.initDOMLoadedElements = function() {
        ...
        Array.prototype.forEach.call(document.querySelectorAll("[data-simplebar]"), (function(e) {
            "init" === e.getAttribute("data-simplebar") || D.instances.has(e) || new D(e,R(e.attributes))
        }
        ))
    }
    ,
    ...
    D.initHtmlApi = function() {
        ...
        "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(D.handleMutations),
    ...
    D.handleMutations = function(e) {
        e.forEach((function(e) {
            Array.prototype.forEach.call(e.addedNodes, (function(e) {
                1 === e.nodeType && (e.hasAttribute("data-simplebar") ? !D.instances.has(e) && new D(e,R(e.attributes)) : Array.prototype.forEach.call(e.querySelectorAll("[data-simplebar]"), (function(e) {
                    "init" === e.getAttribute("data-simplebar") || D.instances.has(e) || new D(e,R(e.attributes))
                }
                )))
            }
            ...
            Array.prototype.forEach.call(e.removedNodes, (function(e) {
                1 === e.nodeType && (e.hasAttribute("data-simplebar") ? D.instances.has(e) && D.instances.get(e).unMount() : Array.prototype.forEach.call(e.querySelectorAll('[data-simplebar="init"]'), (function(e) {
